          ...
          child: Column(
            ...
            children: <Widget>[
              ClipRRect(
                ...
                child: Image.asset("assets/images/${destination.imageUrl}", fit: BoxFit.cover),
              ),
              ...
              Text(
                destination.name,
                style:
                    TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.amber[900]),
              ),
              const SizedBox(height: 8),
              Text(
                destination.country,
                style:
                    TextStyle(fontSize: 18, fontWeight: FontWeight.w500, color: Colors.grey[600]),
              ),
